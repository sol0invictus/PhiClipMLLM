...
class CustomTrainer(Trainer):
    ...
    def get_train_dataloader(self):
        return self._train_dataloader if self._train_dataloader else super().get_train_dataloader()

    def get_eval_dataloader(self, eval_dataset=None):
        return self._eval_dataloader if self._eval_dataloader else super().get_eval_dataloader(eval_dataset)
    ...
    def save_model(self, output_dir=None, _internal_call=True):
        try:
            ...
            self.model.save_checkpoint(os.path.join(output_dir, "model_checkpoint.pt"))
